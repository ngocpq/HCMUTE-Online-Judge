...
namespace SPKTOnline.Management.EnCrypt
{
    public class Cryptography
    {
       ...
       public static bool VerifyMD5Hash(string input, string hash)
        ...
        //    Uses Encrypt(byte[], byte[], byte[]) 
         static byte[] Encrypt(byte[] clearData, string Password)
        {
        ...
        // Encrypt a file into another file using a password 
         static void Encrypt(string fileIn, string fileOut, string Password)
        {
         ...
         static byte[] Decrypt(byte[] cipherData, byte[] Key, byte[] IV)
        {
         ...
         static byte[] Decrypt(byte[] cipherData, string Password)
        {
            PasswordDeriveBytes pdb = new PasswordDeriveBytes(Password, new byte[] { 0x49, 0x76, 0x61, 0x6e, 0x20, 0x4d, 0x65, 0x64, 0x76, 0x65, 0x64, 0x65, 0x76 });
        ...
        // Decrypt a file into another file using a password 
         static void Decrypt(string fileIn, string fileOut, string Password)
        {
            // First we are going to open the file streams 
            FileStream fsIn = new FileStream(fileIn, FileMode.Open, FileAccess.Read);
            FileStream fsOut = new FileStream(fileOut, FileMode.OpenOrCreate, FileAccess.Write);
